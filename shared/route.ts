...
// Pixel coordinates are in the map image's own space (1448 x 1086, matching
// src/assets/map.png — a landscape, labeled overview map). Leaflet CRS.Simple
// maps a Position to LatLng [y, x]; the journey winds Shire (left) -> Mount
// Doom (upper-right) along the drawn path.
export const ROUTE: Waypoint[] = [
  {
    name: "The Shire", x: 185, y: 320, cumulativeMiles: 0,
  ...
  {
    name: "Rivendell", x: 435, y: 240, cumulativeMiles: 458,
  ...
  {
    name: "Mines of Moria", x: 710, y: 293, cumulativeMiles: 800,
  ...
  {
    name: "Lothlorien", x: 840, y: 370, cumulativeMiles: 920,
  ...
  {
    name: "Rauros Falls", x: 912, y: 521, cumulativeMiles: 1309,
  ...
  {
    name: "Minas Tirith", x: 941, y: 728, cumulativeMiles: 1500,
  ...
  {
    name: "The Black Gate", x: 1202, y: 771, cumulativeMiles: 1650,
  ...
  {
    name: "Mount Doom", x: 1245, y: 326, cumulativeMiles: 1779,
